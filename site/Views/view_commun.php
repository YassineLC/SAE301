...
<head>
    ...
    <title>Le Septieme Art - Recherche commun </title>
</head>
<body>
    ...
    <form id="search-form" method="post" onsubmit="updateFormAction()" class="search-form">
            <div class="form-group row">
                <div class="col-md-12" >
                    <input type="text" id="search1" name="search1" class="input-film col-md-14 offset-md-3 text-center" placeholder="Entrer un film ou un acteur">
                </div>
            </div>
